...
* [Git for windows](https://git-scm.com/download/win) - this includes a "Terminal" called *git-bash* that you will use anywhere you see *Terminal* below.  If you like graphical then [GitHub Desktop](https://desktop.github.com/) is also useful.

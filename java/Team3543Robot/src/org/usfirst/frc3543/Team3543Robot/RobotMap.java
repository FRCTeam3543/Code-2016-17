...
public class RobotMap {
    ...
    public static Ultrasonic rangeFinderubSystemUltrasonicFront;
    public static Ultrasonic rangeFinderubSystemUltrasonicRear;
    ...
    public static final int GEAR_APPROACH_CURVE_GAIN = 1;	// gain function for the gear-approach feedback controller 
    ...
    public static void init() {
        ...
        driveLineQuadratureEncoderLeft = new Encoder(4, 5, false, EncodingType.k4X);
        LiveWindow.addSensor("DriveLine", "QuadratureEncoderLeft", driveLineQuadratureEncoderLeft);
        driveLineQuadratureEncoderLeft.setDistancePerPulse(1.0);
        driveLineQuadratureEncoderLeft.setPIDSourceType(PIDSourceType.kRate);
        driveLineQuadratureEncoderRight = new Encoder(6, 7, false, EncodingType.k4X);
        LiveWindow.addSensor("DriveLine", "QuadratureEncoderRight", driveLineQuadratureEncoderRight);
        driveLineQuadratureEncoderRight.setDistancePerPulse(1.0);
        ...
        rangeFinderubSystemUltrasonicFront = new Ultrasonic(0, 1);
        LiveWindow.addSensor("RangeFinderubSystem", "UltrasonicFront", rangeFinderubSystemUltrasonicFront);
        
        rangeFinderubSystemUltrasonicRear = new Ultrasonic(2, 3);
        LiveWindow.addSensor("RangeFinderubSystem", "UltrasonicRear", rangeFinderubSystemUltrasonicRear);

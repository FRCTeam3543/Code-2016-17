...
public class RobotMap {
    ...
    public static final double PID_FORWARD_P = 1;
    public static final double PID_FORWARD_I = 1;
    public static final double PID_FORWARD_D = 1;

    public static final double PID_ANGLE_P = 1;
    public static final double PID_ANGLE_I = 1;
    public static final double PID_ANGLE_D = 1;

...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("ApproachGearDropCommandGroup", new ApproachGearDropCommandGroup(ApproachGearDropCommandGroup.Mode.MIDDLE));
        SmartDashboard.putData("LocateGearDropUsingVisionCommand", new LocateGearDropUsingVisionCommand(0.3, 5));

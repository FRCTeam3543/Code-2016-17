...
import org.usfirst.frc3543.Team3543Robot.commands.ZigZagCommand;
import org.usfirst.frc3543.Team3543Robot.RobotMap.AutonomousMode;
import org.usfirst.frc3543.Team3543Robot.commands.ArcadeDriveWithJoystick;
import org.usfirst.frc3543.Team3543Robot.commands.BallPickupCommand;
import org.usfirst.frc3543.Team3543Robot.commands.DriveForwardByDistanceCommand;
import org.usfirst.frc3543.Team3543Robot.commands.FeedbackApproachGearDropCommand;
import org.usfirst.frc3543.Team3543Robot.commands.GearDropAutonomousCommandGroup;
import org.usfirst.frc3543.Team3543Robot.commands.LiftRobotCommand;
import org.usfirst.frc3543.Team3543Robot.commands.LocateGearDropUsingVisionCommand;
import org.usfirst.frc3543.Team3543Robot.commands.LowerBallChuteCommand;
import org.usfirst.frc3543.Team3543Robot.commands.LowerRobotCommand;
import org.usfirst.frc3543.Team3543Robot.commands.OpenGearHolderCommand;
import org.usfirst.frc3543.Team3543Robot.commands.RaiseBallChuteCommand;
import org.usfirst.frc3543.Team3543Robot.commands.RotateByAngleCommand;
import org.usfirst.frc3543.Team3543Robot.commands.TankDriveWithJoysticks;
...
public class OI {
    ...
    public OI() {
        ...
        resumeArcadeDriveButton.whenPressed(new ArcadeDriveWithJoystick());
        ...
        SmartDashboard.putData("OpenGearHolderCommand", new OpenGearHolderCommand());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        // Motion commands
        SmartDashboard.putData("Drive Forward 12in", new DriveForwardByDistanceCommand(12, 0.3));       
...
//        SmartDashboard.putNumber(GEARFINDER_BLOB_COUNT, 0);
    ...
    public static class Dashboard {
		...
		public void putAutonomousMode(AutonomousMode mode) {
			...
			case LEFT:
				s = "left";
				putAutonomousModeValues(RobotMap.DEFAULT_AUTONOMOUS_LEFT_DISTANCE, RobotMap.DEFAULT_AUTONOMOUS_LEFT_ANGLE);
				break;
			case MIDDLE:
				s = "middle";
			...
			case RIGHT:
				s = "right";
				putAutonomousModeValues(RobotMap.DEFAULT_AUTONOMOUS_RIGHT_DISTANCE, RobotMap.DEFAULT_AUTONOMOUS_RIGHT_ANGLE);				
				break;
			default:
				s = "undefined";
		...
		public void putDistanceRemaining(double d) {
	        SmartDashboard.putNumber(OI.DISTANCE_REMAINING, d);			
		}
		
		public void putDrivelineEncoders(double left, double right) {
	        SmartDashboard.putNumber(OI.DRIVELINE_ENCODER_LEFT, left);
	        SmartDashboard.putNumber(OI.DRIVELINE_ENCODER_RIGHT, right);
		}
		
		public void putDrivelineGyro(double angleInDegrees) {
	        SmartDashboard.putNumber(OI.DRIVELINE_GYRO, angleInDegrees);
		}

		public double getWheelEncoderDistancePerPulse() {
			return SmartDashboard.getNumber(OI.WHEEL_ENCODER_DISTANCE_PER_PULSE, RobotMap.DEFAULT_DISTANCE_PER_PULSE);
		}
